"""
Django settings for aiprocurementvendor_45968 project.
...
ROOT_URLCONF = 'aiprocurementvendor_45968.urls'
...
WSGI_APPLICATION = 'aiprocurementvendor_45968.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aiprocurementvendor_45968 API",
    "DESCRIPTION": "API documentation for aiprocurementvendor_45968 App",
    "VERSION": "v1",
}
